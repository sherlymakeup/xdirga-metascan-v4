      ...
      <div className="mx-auto max-w-[1600px] space-y-3 p-3 md:p-4">
        ...
        <div className="grid gap-3 lg:grid-cols-3">
          ...
          <Panel
            ...
            toolbar={
              <StatusBadge tone={openBreakers.length > 0 ? "crit" : "ok"} size="sm">
        ...
        <Panel
          ...
          subtitle={`${snap.breakers.length} configured`}
          bodyClassName="p-0"
        >
              ...
              <tbody>
                {snap.riskLimits.map((l) => (
                  <tr key={l.key} className="border-b border-panel-border/60">
                    ...
                    <td
                      className={`num px-2 py-1.5 text-right ${l.breached ? "text-status-crit" : ""}`}
                    >
                      {unit(l)}
                    </td>
